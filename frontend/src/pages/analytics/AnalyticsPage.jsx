...
export default function AnalyticsPage() {
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6 p-8">
      ...
      {analytics.role === 'farmer' && <FarmerAnalyticsView data={analytics.data} />}
      {analytics.role === 'expert' && <ExpertAnalyticsView data={analytics.data} />}
      {analytics.role === 'seller' && <SellerAnalyticsView data={analytics.data} />}
      {analytics.role === 'officer' && <OfficerAnalyticsView data={analytics.data} />}
      {analytics.role === 'gov_admin' && <GovAnalyticsView data={analytics.data} />}
      {analytics.role === 'super_admin' && <SuperAdminAnalyticsView data={analytics.data} />}
    </div>
  )
}

function FarmerAnalyticsView({ data }) {
  return (
    <>
...
function ExpertAnalyticsView({ data }) {
  return (
    <>
...
function SellerAnalyticsView({ data }) {
  return (
    <>
...
function OfficerAnalyticsView({ data }) {
  return (
    <>
      <div className="grid grid-cols-2 gap-4">
...
function GovAnalyticsView({ data }) {
  return (
    <>
      <div className="grid grid-cols-2 gap-4">
...
function SuperAdminAnalyticsView({ data }) {
  return (
    <>
