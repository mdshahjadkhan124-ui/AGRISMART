...
import type { DiseaseReportStatus } from '@/features/diseaseReports/types'
...
const statusVariant: Record<DiseaseReportStatus, 'secondary' | 'default' | 'destructive'> = {
  pending: 'secondary',
  in_review: 'default',
  resolved: 'default',
}
          ...
          <CardContent>
            <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                {errors.image && <p className="text-destructive text-sm">{errors.image.message as string}</p>}
              </div>
