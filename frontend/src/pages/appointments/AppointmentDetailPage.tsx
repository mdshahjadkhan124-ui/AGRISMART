...
function CallPanel({ appointmentId }: { appointmentId: string }) {
...
export default function AppointmentDetailPage() {
  ...
  const { data: appointment, isLoading } = useAppointment(id as string)
  const updateStatus = useUpdateAppointmentStatus(id as string)
