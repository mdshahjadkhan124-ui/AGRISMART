...
const soilTypes = ['alluvial', 'black', 'red', 'laterite', 'arid', 'saline', 'peaty', 'forest', 'other'] as const
const irrigationTypes = ['canal', 'borewell', 'drip', 'sprinkler', 'rainfed', 'other'] as const
...
export default function FarmsListPage() {
  ...
  const {
    ...
    watch,
    formState: { errors },
  } = useForm<CreateFarmInput, unknown, CreateFarmValues>({
    resolver: zodResolver(createFarmSchema),
    defaultValues: { soilType: 'other', irrigationType: 'rainfed' },
  })

  const onSubmit = (values: CreateFarmValues) => {
          ...
          <CardContent>
            <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Select value={watch('soilType')} onValueChange={(v) => setValue('soilType', v as CreateFarmValues['soilType'])}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Select
                  ...
                  onValueChange={(v) => setValue('irrigationType', v as CreateFarmValues['irrigationType'])}
                >
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
